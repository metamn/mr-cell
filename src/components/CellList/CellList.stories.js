...
storiesOf('CellList', module)
  ...
  .add('rectangle - horizontal', () => <CellList width={'90vw'} height={'20vh'} numberOfElements={50} />)
  .add('rectangle - vertical', () => <CellList width={'29vw'} height={'80vh'} numberOfElements={120} />)
