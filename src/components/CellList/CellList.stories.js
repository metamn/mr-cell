...
storiesOf('CellList', module)
  ...
  .add('rectangle - horizontal', () => <CellList width={'90vw'} height={'33vh'} numberOfElements={91} />)
  .add('rectangle - vertical', () => <CellList width={'30em'} height={'80vh'} numberOfElements={121} />)
